...
public class Claw implements Component{
    ...
    private final double CLAW_OPEN_POSITION = 0;   // Adjust as needed for your claw design
    private final double CLAW_CLOSE_POSITION = 0.02;  // Adjust as needed for your claw design
